...
train_all_f_init = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/law.pt')
train_l_init = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/law_label.pt')
...
learn.save_all(path='时序模型_exp2_law', dls_fname='dls', model_fname='model', learner_fname='learner')
