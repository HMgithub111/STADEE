...
train_all_f_init = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/用cpm低p生成一些文本/feature/cnews1.pt')
train_l_init = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/用cpm低p生成一些文本/feature/cnews1_label.pt')

train_file = ['2','3','4','5','6','7','8']
for file in train_file:
    train_all_f_init += torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/用cpm低p生成一些文本/feature/cnews'+file+'.pt')
    train_l_init += torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/用cpm低p生成一些文本/feature/cnews'+file+'_label.pt')
...
test_all_f = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/finance.pt')
test_l = torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/finance_label.pt')
test_file = ['medicine','psychology','baike','law','nlpcc','openqa']
for file in test_file:
    test_all_f += torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/'+file+'.pt')
    test_l += torch.load('/root/new_exp/XL/以transformer-xl作为提取模型/chatGPT/data_all_eTz/feature_z_all_110M_clean/'+file+'_label.pt')
...
learn.save_all(path='时序模型_exp3', dls_fname='dls', model_fname='model', learner_fname='learner')
